...
| 18 | Flyway e versionamento do banco de dados | Backlog | [Arquivo](backlog/18-flyway-e-versionamento-do-banco-de-dados.md) |
...
* 18 — Flyway e versionamento do banco de dados
* 19 — LoginUserUseCase
* 20 — Emissão de JWT
* 21 — JWT com RS256
* 22 — Endpoint JWKS
